      ...
      <nav className="md:left-0 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl bg-white flex flex-wrap items-center justify-between relative md:w-64 z-10 py-4 px-6">
        <div className="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
          ...
          <div className="inline-flex items-center">
            {/* Image */}
            <img alt="blue biz logo" className="h-auto max-w-xs mr-2" style={{ maxWidth: '50px' }} src="/img/logo/2232688.png"/>

            {/* Brand */}
            <Link href="/admin/dashboard">
              <a
                href="#pablo"
                className="md:block text-left md:pb-2 text-blueGray-600 inline-block whitespace-nowrap text-sm uppercase font-bold p-4 px-0"
              >
                Blue Biz
              </a>
            </Link>
                  ...
                  >
                    <i
                      className={
                        ...
                        (router.pathname.indexOf("/admin/formbuilder") !== -1
                          ? "opacity-75"
                          : "text-blueGray-300")
                      }
                    ></i>{" "}
